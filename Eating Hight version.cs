...
{
    public class GrabAndEatHight : MonoBehaviour
    {
        ...
        public void OnNetworkEatReceived(bool isEnabled)
        {
            ...
            // Add this inside OnNetworkEatReceived(), after the `if (isEnabled) return;` guard,
            // and make sure it only fires for the local player:
